            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack(spacing: 14) {
                    ...
                    GameCategoryCard(
                        ...
                        gameCount: 2,
                        games: ["RotateTheRoute","NetIsolator"]
                    )
                    GameCategoryCard(
                        title: "Home Science",
                        description: "Match culinary cards and master food preparation and sewing knowledge.",
                        icon: "fork.knife",
                        bgColor: Color(hex: "#FCE4EC"),
                        accentColor: Color(hex: "#E91E63"),
                        gameCount: 2,
                        games: ["Culinary Memory Card", "Fashion & Sewing"]
                    )
                }
                .padding(.horizontal, 20)
                .padding(.vertical, 4)
